...
<head>
    ...
    <meta name="description" content="EZMart">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <script src="<c:url value="/resources/js/modernizr-2.8.3.min.js"/>"></script>
    <!-- CSS -->
    <link rel="stylesheet" href="<c:url value="/resources/css/normalize.css"/>">
    <link rel="stylesheet" href="<c:url value="/resources/css/main.css"/>">
    <link rel="stylesheet" href="<c:url value="/resources/css/appEZMart.css"/>">
    ...
    <![endif]-->
    <!-- Favicons-->
    <link rel="icon" href="<c:url value="/resources/img/logo_preto_icon.png"/>" sizes="30x30">
    <!-- Favicons-->
    <!-- For iPhone -->
