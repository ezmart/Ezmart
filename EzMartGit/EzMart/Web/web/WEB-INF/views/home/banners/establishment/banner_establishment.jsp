...
<ul class="slides">
    ...
    <li>
        ...
        <div class="caption left-align">
            ...
            <h3 class="light text-lighten-1" style="color: #000000"><b>Ajudando a fazer a escolha certa.</b></h3>
    ...
    <li>
        ...
        <div class="caption center-align">
            <h3 class="light text-lighten-1" style="color: #000000"><b>Cadestre seus produtos hoje.</b></h3>
